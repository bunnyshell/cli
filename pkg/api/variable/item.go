...
func Get(options *common.ItemOptions) (*sdk.EnvironmentVariableItem, error) {
...
func GetRaw(options *common.ItemOptions) (*sdk.EnvironmentVariableItem, *http.Response, error) {
