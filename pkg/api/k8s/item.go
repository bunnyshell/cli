...
func Get(options *common.ItemOptions) (*sdk.KubernetesIntegrationItem, error) {
...
func GetRaw(options *common.ItemOptions) (*sdk.KubernetesIntegrationItem, *http.Response, error) {
