...
func Get(options *common.ItemOptions) (*sdk.TemplatesRepositoryItem, error) {
...
func GetRaw(options *common.ItemOptions) (*sdk.TemplatesRepositoryItem, *http.Response, error) {
